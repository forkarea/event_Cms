app.controller('reportNewCtrl', ['$scope', '$rootScope', 'informService', 'Upload', '$timeout',
	function ($scope, $rootScope, informService, Upload, $timeout) {
		...
		$rootScope.$on('clear.new.report', function (event, value) {
		...
		$scope.uploadPhoto = function(file, form) {
			...
			file.upload.then(function (response) {
				$timeout(function () {
					$rootScope.$emit('new.report.photo', '');
