app.controller('organizersNewCtrl', ['$scope', '$rootScope', 'informService', 'Upload', '$timeout',
	function ($scope, $rootScope, informService, Upload, $timeout) {
		...
		$rootScope.$on('clear.new.organizers', function (event, value) {
		...
		$scope.uploadPhoto = function(file, form) {
			...
			file.upload.then(function (response) {
				$timeout(function () {
					$rootScope.$emit('new.organizers.photo', '');
